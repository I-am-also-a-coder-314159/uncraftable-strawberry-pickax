...
public class StrawberrymcMod {
	public static final Logger LOGGER = LogManager.getLogger(StrawberrymcMod.class);
	public static final String MODID = "strawberrymc";

	public StrawberrymcMod(IEventBus modEventBus) {
