...
public class RecoveryPearlProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(StrawberrymcModItems.RECOVERY_PEARL.get());
	private int knockback = 0;

	public RecoveryPearlProjectileEntity(EntityType<? extends RecoveryPearlProjectileEntity> type, Level world) {
		super(type, world);
	}

	public RecoveryPearlProjectileEntity(EntityType<? extends RecoveryPearlProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public RecoveryPearlProjectileEntity(EntityType<? extends RecoveryPearlProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(StrawberrymcModItems.RECOVERY_PEARL.get());
	}
	...
	public static RecoveryPearlProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 0, 0);
	}

	public static RecoveryPearlProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 0, 0);
	}

	public static RecoveryPearlProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
	...
	public static RecoveryPearlProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		RecoveryPearlProjectileEntity entityarrow = new RecoveryPearlProjectileEntity(StrawberrymcModEntities.RECOVERY_PEARL_PROJECTILE.get(), entity, entity.level(), null);
