...
import io.github.strawberrymc.procedures.CoconutHitParticleProcedure;
...
public class CoconutProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(StrawberrymcModItems.COCONUT.get());
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(StrawberrymcModItems.COCONUT.get());
	}
	...
	public void playerTouch(Player entity) {
		...
		CoconutHitParticleProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		CoconutHitParticleProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static CoconutProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		CoconutProjectileEntity entityarrow = new CoconutProjectileEntity(StrawberrymcModEntities.COCONUT_PROJECTILE.get(), entity, world, null);
	...
	public static CoconutProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		CoconutProjectileEntity entityarrow = new CoconutProjectileEntity(StrawberrymcModEntities.COCONUT_PROJECTILE.get(), entity, entity.level(), null);
